...
*</p>
* <p>
* Initialisiert und schreibt Logging-Informationen in die Datei db2views_logging.csv
*</p>
*
* @version 1.0
...
public class Logging {
	...
	private String loggingHeader = "Zeitpunkt,DB2View,Logtyp,Information";
...
public Logging(Init init) throws IOException {
	  ...
	  this.logWriter = new FileWriter(this.targetDirectory+"db2views_logging.csv");
